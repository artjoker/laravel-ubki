<?php
    ...
    return [
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Request reason (reqreason) for credit report queries (Код из спр.24)
        |   0 - Передача данных (Передача кредитных историй в УБКИ)
        |   1 - Мониторинг клиента организации
        |   2 - Заявка на кредит
        |   3 - Получение отчетов для смартфона
        |   4 - Заявка на онлайн кредит
        |   5 - Прочие услуги
        |   6 - Верификация
        |--------------------------------------------------------------------------
        */
        'reqreason'               => env('UBKI_REQREASON', 4),

        /*
        |--------------------------------------------------------------------------
        | Request reason (reqreason) for upload of credit histories (Код из спр.24)
        |--------------------------------------------------------------------------
        */
        'upload_reqreason'        => env('UBKI_UPLOAD_REQREASON', 0),
